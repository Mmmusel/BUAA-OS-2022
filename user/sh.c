...
runcmd(char *s) {
   ...
   // prog_name_len += 2;
    ...
    if ((child_envid = spawn(prog_name, argv)) < 0) {
        writef("Musel's Shell: command not found " RED([%s]) "\n", prog_name);
    }
    ...
    if (r >= 0) {
        ...
        if (!hang) wait(r);
            ...
            if (pid == 0) {
                ...
                curpath_get(curpath);
               // writef("\n" LIGHT_BLUE(%s:%s) " " BOLD_GREEN($) " ","Musel's Shell",curpath);
                writef("\b \b");
                exit();
            }
        }
...
umain(int argc, char **argv) {
    ...
    echocmds = 0;
    writef("\n\033[0;33m:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\033[m\n");
    writef("\033[0;33m::                                                                 ::\033[m\n");
    writef("\033[0;33m::\033[m                 \033[0;33m Musel's Shell  Lab6-Challenge\033[m                 \033[0;33m ::\033[m\n");
    writef("\033[0;33m::                                                                 ::\033[m\n");
    writef("\033[0;33m:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\033[m");
    ARGBEGIN
    {
